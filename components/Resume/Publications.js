      ...
      <Section label="Publications">
        {map(publications, publication => {
          return (
            <Job>
              <JobHeader>
                <JobCompany>{publication.name}</JobCompany>

                <JobDate>{publication.releaseDate}</JobDate>
              </JobHeader>
              <JobPosition>{publication.publisher}</JobPosition>
              <JobSummary>{publication.summary}</JobSummary>
              <br />
              <JobWebsite>
                <Link target="_blank" href={publication.website}>
                  {publication.website}
                </Link>
              </JobWebsite>
              <JobSpacer />
