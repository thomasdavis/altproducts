      ...
      <Section label="Volunteer">
        {map(volunteer, v => {
          return (
            <Job>
              <JobHeader>
                <JobCompany>{v.organization}</JobCompany>

                <JobDate>
                  {v.startDate} - {v.endDate ? v.endDate : "Ongoing"}
                </JobDate>
              </JobHeader>
              <JobPosition>{v.position}</JobPosition>
              <JobSummary>{v.summary}</JobSummary>
              <JobHighlights>
                {map(v.highlights, highlight => {
                  return (
                    <JobHighlight>
                      <Body>{highlight}</Body>
                    </JobHighlight>
              ...
              <JobWebsite>
                <Link to={v.website}>{v.website}</Link>
              </JobWebsite>
              <JobSpacer />
            </Job>
          );
